module.exports = {
	...
	getCustomer: "select stripe_customer_id, update_time, email, metadata from tamedstripe.customers where application_customer_id = $1 and state = 'A'",
	...
	getAccount: "select stripe_account_id, state, update_time from tamedstripe.connected_accounts where application_customer_id = $1",
