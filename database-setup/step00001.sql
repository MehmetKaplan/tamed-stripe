...
create table tamedstripe.customers (
	...
	state varchar(1), -- 'W'aiting for payment method, 'A'ctive, 'C'ancel, 
	update_time timestamp not null,
...
create unique index customers_idx3 on tamedstripe.customers(checkout_session_id);
alter table
	tamedstripe.customers
add
	constraint customers_check2 check (state in ('W', 'A', 'C')); 
...
create table tamedstripe.invoices (
	id integer generated by default as identity primary key,
